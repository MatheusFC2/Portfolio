    ...
    return (
      <Container>
        ...
        <Section>
          ...
          <Paragraph>
            Sou programador front-end apaixonado por tecnologia, também sou Estudante de Administração junto com o Ensino Medio. Tenho {new Date().getFullYear() - yearExperience.getFullYear()} anos de experiência com as principais tecnologias: <i>HTML, CSS, JavaScript, React Native e ReactJS</i>.
          </Paragraph>
